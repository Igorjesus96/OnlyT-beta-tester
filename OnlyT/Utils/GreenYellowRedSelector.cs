﻿namespace OnlyT.Utils
{
    ...
    public static class Animations
    {
        ...
        // Função para fazer a tela piscar quando o contador se encerrar
        public static void FlashScreen(FrameworkElement parentContainer)
        {
            // Faz a tela piscar usando o método Flash da classe Animations.
            Animations.Flash(parentContainer, parentContainer, OnFlashCompleted);
        }

        // Manipulador de eventos para quando o efeito de flash terminar
        private static void OnFlashCompleted(object sender, EventArgs e)
        {
            // Ações a serem tomadas após o flash completar.
